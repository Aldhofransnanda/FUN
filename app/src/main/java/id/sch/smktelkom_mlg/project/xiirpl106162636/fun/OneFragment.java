                ...
                public void onClick(View view) {
                    switch (view.getId()) {
                        case R.id.button1:
                            ...
                            btn_unfocus = btn[0];
                            ((FragmentCommunication) getActivity()).getAnswer1(currentQ.getOPTA());
                            break;

                        case R.id.button2:
                            setFocus(btn_unfocus, btn[1]);
                            btn_unfocus = btn[1];
                            ((FragmentCommunication) getActivity()).getAnswer1(currentQ.getOPTB());
                            break;

                        case R.id.button3:
                            setFocus(btn_unfocus, btn[2]);
                            btn_unfocus = btn[2];
                            ((FragmentCommunication) getActivity()).getAnswer1(currentQ.getOPTC());
                            break;

                        case R.id.button4:
                            setFocus(btn_unfocus, btn[3]);
                            btn_unfocus = btn[3];
                            ((FragmentCommunication) getActivity()).getAnswer1(currentQ.getOPTD());
                            break;

                        case R.id.button5:
                            setFocus(btn_unfocus, btn[4]);
                            btn_unfocus = btn[4];
                            ((FragmentCommunication) getActivity()).getAnswer1(currentQ.getOPTE());
                            break;
                    }
                }
            });
