...
public class SixFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = lf.inflate(R.layout.fragment_six, container, false); //pass the correct layout name for the fragment
        ...
        currentQ = quesList.get(qid + 5); // the current question
                ...
                public void onClick(View view) {
                    switch (view.getId()) {
                        case R.id.button1:
                            ...
                            btn_unfocus = btn[0];
                            String str = btn[0].getText().toString();
                            ((FragmentCommunication) getActivity()).getAnswer6(currentQ.getOPTA());
                            break;

                        case R.id.button2:
                            setFocus(btn_unfocus, btn[1]);
                            btn_unfocus = btn[1];
                            str = btn[1].getText().toString();
                            ((FragmentCommunication) getActivity()).getAnswer6(currentQ.getOPTB());
                            break;

                        case R.id.button3:
                            setFocus(btn_unfocus, btn[2]);
                            btn_unfocus = btn[2];
                            str = btn[2].getText().toString();
                            ((FragmentCommunication) getActivity()).getAnswer6(currentQ.getOPTC());
                            break;

                        case R.id.button4:
                            setFocus(btn_unfocus, btn[3]);
                            btn_unfocus = btn[3];
                            str = btn[3].getText().toString();
                            ((FragmentCommunication) getActivity()).getAnswer6(currentQ.getOPTD());
                            break;

                        case R.id.button5:
                            setFocus(btn_unfocus, btn[4]);
                            btn_unfocus = btn[4];
                            str = btn[4].getText().toString();
                            ((FragmentCommunication) getActivity()).getAnswer6(currentQ.getOPTE());
                            break;
                    }
                }
            });
